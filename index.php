...
<title>RisE | A Paranormal Research Team</title>
<meta name="keywords" content="Paranormal Research, Paranormal Activity, Paranormal Help, Paranormal Investigation, Professional Paranormal Team, Colorado Paranormal, Colorado Ghost Hunters, Denver Paranormal, Denver Ghost Hunters, Rise Para, Rise Paranormal Research Team, Kris Schmidt, Chris Koerber, Erik Madrill" />
<meta name="description" content="RisE Paranormal is a team of dedicated professionals whose purpose is to research events involving the unexplainable, and provide assistance to those afflicted by interactions with the paranormal." />
    ...
    <td><table width="100%" border="0" cellpadding="6" cellspacing="1">
      <tr>
        ...
        <td width="594" align="left" valign="top" bgcolor="#FFFFFF"><!-- InstanceBeginEditable name="Page_Content" -->
          <h2>Who we Are</h2>
          <p>RisE Paranormal is a team of dedicated  professionals whose purpose is to research events involving the unexplainable,  and provide assistance to those afflicted by interactions with the paranormal.  Our team is committed to using a dominantly scientific approach in our research  methods to document and investigate each case. We are more than happy to  provide clients with contacts in religious fields if they are seeking spiritual  guidance. </p>
